    ...
    class Program
    {
        ...
        public static void ExemplosListasColecoes()
        {
            ...
            do
            {
                ...
                Console.WriteLine("11 - Cadastro de salário");
                Console.WriteLine("12 - Cadastro de nome");
                Console.WriteLine("==================================================");
                ...
                switch (opcaoEscolhida)
                {
                    ...
                    case 11:
                        ...
                        decimal Salario = decimal.Parse(Console.ReadLine());
                        ValidarSalarioAdmissao(Salario);
                        break;
                    case 12:
        ...
        public static void ValidarSalarioAdmissao(decimal Salario)
        {
        ...
        if (Length <= 2)
        {
            Console.WriteLine("Nome invalido! (acima de 3 caracteres)");
            return;
        } else {
